% function image1 = generate_warped_image(images, homographies)
%
% Method: warp all the images into one image according to 
%         the corresponding homography. The order of the images determine 
%         which image is on top 
%
% Input: images is a cell of images (double)
%        homographies is a cell (n,1) of all homographies 3,3 matrix 
%        It is: point (image ref) = homographies{i} point (image i)
% 
